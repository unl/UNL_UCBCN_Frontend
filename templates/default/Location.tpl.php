...
if (isset($this->directions)) {
    echo '<div class="directions">'.UNL_UCBCN_Frontend::dbStringToHtml($this->directions).'</div>';
}
if (isset($this->additionalpublicinfo)) {
    echo '<div class="additionalinfo">'.UNL_UCBCN_Frontend::dbStringToHtml($this->additionalpublicinfo).'</div>';
}
?>
</div>