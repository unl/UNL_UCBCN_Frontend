...
<div class="week_cal" id="month_viewcal">
    <table class="wp-calendar">
        <caption>
            <span><a href="<?php echo $context->getPreviousURL(); ?>" id="prev_week" title="View events for week <?php echo $prev->format('W'); ?>">&lt;&lt; </a></span>
            <span class="monthvalue">
                <a href="<?php echo $context->getURL(); ?>">Week <?php echo $context->getDateTime()->format('W'); ?></a>
            </span>
            of
            <span class="yearvalue">
                <a href="<?php echo $context->getYearURL(); ?>"><?php echo $context->getDateTime()->format('Y'); ?></a>
            </span>
            <span><a href="<?php echo $context->getNextURL(); ?>" id="next_week" title="View events for week <?php echo $next->format('W'); ?>"> &gt;&gt;</a></span>
        </caption>
        <thead>
        <?php
        $weekdays = array(
